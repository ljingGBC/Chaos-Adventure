...
namespace CreativeSpore.RpgMapEditor
{
	...
	public class TileChunkPool : MonoBehaviour 
	{
        ...
        private Dictionary<string, int> m_dicDefaultLayerId = new Dictionary<string, int>();
		...
		public void Initialize (AutoTileMap autoTileMap)
		{
			...
			foreach( TileChunkLayer tileChunkLayer in TileChunkLayers )
			{
				...
				{
                    m_dicDefaultLayerId[tileChunkLayer.ObjNode.name] = tileChunkLayer.ObjNode.layer;
                #if UNITY_EDITOR
